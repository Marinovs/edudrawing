  ...
  async componentDidMount() {
    ...
    const fetchRooms = async () => {
      ...
      const response = await fetch('http://localhost:5000/api/rooms', {
        ...
        body: JSON.stringify({ id: master._id }),
      });
      ...
      md:p-5 transition-all duration-150"
                      >
                        <img
                          ...
                          src={
                            this.state.master.info?.img !== ''
                              ? '/uploads/' + this.state.master.info?.img
        ...
        text-black text-center m-auto md:m-0 md:mt-8"
          ...
          <div className="flex flex-col space-y-4 mt-12 mb-24 md:flex-row items-center w-auto md:space-x-24 md:justify-center">
            <div>
              <button
